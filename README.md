...
For a detailed derivation of the algorithm, including NIW conjugacy and MCMC steps, please refer to the [Mathematical Framework](docs/Mathematical_Framework.pdf).

## Key Results
### PPM vs PPMx Comparison
The inclusion of spatial covariates (ecliptic coordinates) allows the model to better resolve the galactic structure compared to a standard model.
